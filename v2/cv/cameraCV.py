...
def runCV():
	...
	face_cascade = cv2.CascadeClassifier('../Desktop/Doorman/api//models/haarcascade_frontalface_alt.xml')
	emotion_model = model_from_json(open('../Desktop/Doorman/api//models/facial_expression_model_structure.json', 'r').read())
	emotion_model.load_weights('../Desktop/Doorman/api//models/facial_expression_model_weights.h5')
	emotions = ('angry', 'disgust', 'fear', 'happy', 'sad', 'surprise', 'neutral')
	name_model = load_model('../Desktop/Doorman/api//models/name_model3.h5')

	cap = cv2.VideoCapture(0)
	people = {0:"R", 1:"V", 2:"S", 3:"A", 4:"Rando"}
	counter = 0
	...
	while(True):
		...
		for (x,y,w,h) in faces:
			if w > 100: #trick: ignore small faces
				...
				cv2.imwrite( "images/r" + str(counter) + ".jpg", detected_face );
				counter += 1
				...
				cvSocket.sendto(maxEmotion.encode(), ('127.0.0.1', 8003))
